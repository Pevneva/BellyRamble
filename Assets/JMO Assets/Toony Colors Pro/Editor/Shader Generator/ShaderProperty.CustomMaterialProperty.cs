    ...
    namespace ShaderGenerator
    {
        public partial class ShaderProperty
        {
            ...
            public class CustomMaterialProperty : IMaterialPropertyName
            {
                ...
                public string Label
                {
                    get { return implementation.Label; }
                }

                public bool HasErrors
                {
                    get { return implementation.HasErrors; }
                }

                public bool IsGpuInstanced
                {
                    get { return implementation.IsGpuInstanced; }
                }
                ...
                {
                    implementation =
                        (Imp_MaterialProperty) Activator.CreateInstance(implementationType, new object[] {sp});
                    var menuLabel = implementationType.GetProperty("MenuLabel",
