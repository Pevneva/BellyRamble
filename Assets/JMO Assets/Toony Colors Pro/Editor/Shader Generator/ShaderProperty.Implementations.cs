    ...
    namespace ShaderGenerator
    {
        public partial class ShaderProperty
        {
            ...
            public class Implementation
            {
                ...
                [Serialization.SerializeAs("op")]
                public Operator
                    @operator = Operator.Multiply; //How this implementation is calculated compared to the previous one

                [Serialization.SerializeAs("lbl"), ExcludeFromCopy]
                public string Label = "Property Label";

                [Serialization.SerializeAs("gpu_inst")]
                public bool IsGpuInstanced = false;

                [Serialization.SerializeAs("locked"), ExcludeFromCopy]
                public bool IsLocked = false;

                [Serialization.SerializeAs("impl_index"), ExcludeFromCopy]
                public int DefaultImplementationIndex = -1; // if >= 0, then this is a default implementation

                // Default implementation helpers: system used to check if a variable is different than the default one (highlight labels)
                protected bool IsDefaultImplementation
                {
                    get { return DefaultImplementationIndex >= 0; }
                }
                ...
                internal virtual bool CanBeCopied()
                {
                    return true;
                }
                ...
                string DebugSerializableProps()
                {
                    ...
                    foreach (var prop in props)
                    {
                        ...
                        {
                            var spRef = (ShaderProperty) prop.GetValue(this, null);
                            result.AppendLine(prop.Name + " = " + spRef != null
                                ? spRef.Name
                                : "EmptyShaderPropertyRef");
                        }
                        else
                        {
                ...
                internal virtual string GUILabel()
                {
                    return "Error: base Implementation class";
                }

                //Shader code output that goes in the ShaderLab Properties { } block
                internal virtual string PrintProperty(string indent)
                {
                    return null;
                }

                //Shader code output that declares the variables, if any
                internal virtual string PrintVariableDeclare(string indent)
                {
                    return null;
                }

                //Shader code output that declares the variables that are incompatible with CBUFFER blocks
                internal virtual string PrintVariableDeclareOutsideCBuffer(string indent)
                {
                    return null;
                }
                ...
                internal virtual string PrintVariableFragment(string inputSource, string outputSource, string arguments)
                {
                    return null;
                }

                //shader code output that represents the variable in the vertex shader
                internal virtual string PrintVariableVertex(string inputSource, string outputSource, string arguments)
                {
                    return PrintVariableFragment(inputSource, outputSource, arguments);
                }

                //output the value of a fixed function property: either a constant value, or a material property
                internal virtual string PrintVariableFixedFunction()
                {
                    throw new InvalidOperationException(
                        "This implementation cannot be used with fixed function properties.");
                }

                //Returns a list of features needed to make this implementation work, such as USE_VERTEX_COLORS (enum)
                internal virtual OptionFeatures[] NeededFeatures()
                {
                    return new OptionFeatures[0];
                }

                //Returns a list of extra features needed to make this implementation work (raw strings)
                internal virtual string[] NeededFeaturesExtra()
                {
                    return new string[0];
                }
                ...
                internal virtual bool HasOperator()
                {
                    return true;
                }
            ...
            {
                internal override bool CanBeCopied()
                {
                    return false;
                }

                public static VariableType VariableCompatibility
                {
                    get { return VariableTypeAll; }
                }
                ...
                internal override string GUILabel()
                {
                    return MenuLabel;
                }
                ...
                internal override string PrintVariableFragment(string inputSource, string outputSource,
                    string arguments)
                {
                    return this.Label;
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        TCP2_GUI.HelpBoxLayout(
                            "Add implementations to this Shader Property to modify the output of this variable in the shader.",
                            MessageType.Info);
                    }
                    EndHorizontal();
                }
            ...
            public abstract class Imp_MaterialProperty : Implementation, IMaterialPropertyName
            {
                ...
                [Serialization.SerializeAs("prop"), ExcludeFromCopy]
                public string _PropertyName = "_ShaderProperty";
                ...
                protected bool IsCustomMaterialPropertyReferenced()
                {
                    ...
                    {
                        throw new Exception(
                            "'IsCustomMaterialPropertyReferenced' shouldn't be used when 'IsCustomMaterialProperty' is false");
                    }
                    ...
                    foreach (var sp in ShaderGenerator2.CurrentConfig.VisibleShaderProperties)
                    {
                        foreach (var imp in sp.implementations)
                        {
                            ...
                            {
                                if (imp_cmp.LinkedCustomMaterialProperty != null &&
                                    imp_cmp.LinkedCustomMaterialProperty.implementation == this)
                                {
                                    isReferenced = true;
                    ...
                    {
                        CustomMaterialPropertyReferences =
                            CustomMaterialPropertyReferences.Substring(0,
                                CustomMaterialPropertyReferences.Length - 2); // remove trailing ", "
                    }
                ...
                {
                    return this.IsGpuInstanced
                        ? string.Format("UNITY_ACCESS_INSTANCED_PROP(Props, {0})", variableName)
                        : variableName;
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    BeginHorizontal();
                    {
                        ShaderGenerator2.ContextualHelpBox(string.Format(
                            "Will create a {0} property that you can tweak in the Material Inspector, or with scripts with the Material or Shader APIs.",
                            PropertyTypeName()));
                    }
                    EndHorizontal();
                    GUILayout.Space(4f);
                    ...
                    if (IsCustomMaterialProperty)
                    {
                        ...
                        BeginHorizontal();
                        {
                            ...
                            string label = isReferenced
                                ? "<b><color={0}>Referenced by:</color></b> " + CustomMaterialPropertyReferences
                        ...
                        {
                            GUILayout.Space(2);
                            SGUILayout.DrawLine(EditorGUIUtility.isProSkin
                                ? new Color(.3f, .3f, .3f)
                    ...
                    BeginHorizontal();
                    {
                        ...
                        if (GUI.Button(buttonRect, TCP2_GUI.TempContent(">", "Generate from Label"),
                            SGUILayout.Styles.ShurikenMiniButtonFlexible))
                        {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? !string.IsNullOrEmpty(MaterialDrawers)
                            : MaterialDrawers != GetDefaultImplementation<Imp_MaterialProperty>().MaterialDrawers;
                        SGUILayout.InlineLabel("Property Drawers",
                            "Add one or multiple property drawers/decorators to this property\n(e.g. [NoScaleOffset])",
                            highlighted);
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? IsGpuInstanced
                            : IsGpuInstanced != GetDefaultImplementation<Imp_MaterialProperty>().IsGpuInstanced;
                        SGUILayout.InlineLabel("GPU Instanced",
                            "Tag this property as a possible variant for GPU instancing", highlighted);
            ...
            public class Imp_MaterialProperty_Float : Imp_MaterialProperty
            {
                public static VariableType VariableCompatibility
                {
                    get { return VariableTypeAll | VariableType.fixed_function_float; }
                }

                public static string MenuLabel
                {
                    get { return "Material Property/Float"; }
                }
                ...
                protected override string PropertyTypeName()
                {
                    return "float";
                }
                ...
                internal override string PrintProperty(string indent)
                {
                    return base.PrintProperty(indent) + string.Format(CultureInfo.InvariantCulture,
                        "{0} (\"{1}\", Float) = {2}", PropertyName, Label, DefaultValue);
                }

                internal override string PrintVariableDeclare(string indent)
                {
                    return string.Format("float {0};", PropertyName);
                }

                internal override string PrintVariableFragment(string inputSource, string outputSource,
                    string arguments)
                {
                    return FetchVariable(PropertyName);
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? DefaultValue != 1.0f
                            : DefaultValue != GetDefaultImplementation<Imp_MaterialProperty_Float>().DefaultValue;
            ...
            public class Imp_MaterialProperty_Range : Imp_MaterialProperty
            {
                ...
                public static string MenuLabel
                {
                    get { return "Material Property/Range"; }
                }
                ...
                {
                    return base.PrintProperty(indent) + string.Format(CultureInfo.InvariantCulture,
                        "{0} (\"{1}\", Range({3},{4})) = {2}", PropertyName, Label, DefaultValue, Min, Max);
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Min != 0.0f
                            : Min != GetDefaultImplementation<Imp_MaterialProperty_Range>().Min;
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Max != 1.0f
                            : Max != GetDefaultImplementation<Imp_MaterialProperty_Range>().Max;
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? DefaultValue != 0.5f
                            : DefaultValue != GetDefaultImplementation<Imp_MaterialProperty_Range>().DefaultValue;
                        SGUILayout.InlineLabel("Default Value", highlighted);
                        DefaultValue = SGUILayout.FloatField(DefaultValue);
                    }
                    EndHorizontal();
            ...
            public class Imp_MaterialProperty_Vector : Imp_MaterialProperty
            {
                public static VariableType VariableCompatibility
                {
                    get
                    {
                        return VariableType.float2 | VariableType.float3 | VariableType.float4 | VariableType.color |
                               VariableType.color_rgba;
                    }
                }

                public static string MenuLabel
                {
                    get { return "Material Property/Vector"; }
                }
                ...
                {
                    return base.PrintProperty(indent) + string.Format(CultureInfo.InvariantCulture,
                        "{0} (\"{1}\", Vector) = ({2},{3},{4},{5})", PropertyName, Label, DefaultValue.x,
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ...
                            : DefaultValue != GetDefaultImplementation<Imp_MaterialProperty_Vector>().DefaultValue;
                        SGUILayout.InlineLabel("Default Value", highlighted);
                        int channelsCount = usedByCustomCode ? 4 : ChannelsCount;
                        switch (channelsCount)
                        {
                            case 4:
                                DefaultValue = SGUILayout.Vector4Field(DefaultValue);
                                break;
                            case 3:
                                DefaultValue = SGUILayout.Vector3Field(DefaultValue);
                                break;
                            case 2:
                                DefaultValue = SGUILayout.Vector2Field(DefaultValue);
                                break;
                        }
                    }
                    EndHorizontal();
                    ...
                    if (!IsCustomMaterialProperty)
                    {
                        BeginHorizontal();
                        {
                            bool highlighted = !IsDefaultImplementation
                                ...
                                : Channels != GetDefaultImplementation<Imp_MaterialProperty_Vector>().Channels;
                            ...
                            if (usedByCustomCode)
                            {
                                using (new EditorGUI.DisabledScope(true))
                                {
                                    GUILayout.Label(TCP2_GUI.TempContent("Defined in Custom Code"),
                                        SGUILayout.Styles.ShurikenValue, GUILayout.Height(16),
            ...
            public class Imp_MaterialProperty_Color : Imp_MaterialProperty
            {
                ...
                public static string MenuLabel
                {
                    get { return "Material Property/Color"; }
                }
                ...
                {
                    return base.PrintProperty(indent) + string.Format(CultureInfo.InvariantCulture,
                        "{7}{6}{0} (\"{1}\", Color) = ({2},{3},{4},{5})", PropertyName, Label, DefaultValue.r,
                        DefaultValue.g, DefaultValue.b, DefaultValue.a, Hdr ? "[HDR] " : "",
                        ChannelsCount < 4 ? "[TCP2ColorNoAlpha] " : "");
                }
                ...
                internal override string PrintVariableDeclare(string indent)
                {
                    ...
                    //var channels = ChannelsCount > 1 ? ChannelsCount.ToString() : "";
                    string channels = "4";
                    return string.Format("{0}{1} {2};", Hdr ? FloatPrecision.half : FloatPrecision.@fixed, channels,
                        PropertyName);
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ...
                            : DefaultValue != GetDefaultImplementation<Imp_MaterialProperty_Color>().DefaultValue;
                        SGUILayout.InlineLabel("Default Value", highlighted);
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Hdr
                            : Hdr != GetDefaultImplementation<Imp_MaterialProperty_Color>().Hdr;
                    ...
                    if (!IsCustomMaterialProperty)
                    {
                        BeginHorizontal();
                        {
                            bool highlighted = !IsDefaultImplementation
                                ? Channels != DefaultChannels
                                : Channels != GetDefaultImplementation<Imp_MaterialProperty_Color>().Channels;
                            SGUILayout.InlineLabel("Swizzle", highlighted);
            ...
            public class Imp_MaterialProperty_Texture : Imp_MaterialProperty
            {
                ...
                public static string MenuLabel
                {
                    get { return "Material Property/Texture"; }
                }
                ...
                public override bool HasErrors
                {
                    get
                    {
                        bool linkedSpErrors = UvSource == UvSourceType.OtherShaderProperty &&
                                              (_linkedShaderProperty == null || (_linkedShaderProperty != null &&
                                                  !_linkedShaderProperty.IsVisible()));

                        return base.HasErrors | linkedSpErrors | (UseTilingOffset && invalidTilingOffsetVariable) |
                ...
                internal override OptionFeatures[] NeededFeatures()
                {
                    ...
                    {
                        list.Add(ScreenSpaceUVVertex
                            ? OptionFeatures.Screen_Space_UV_Vertex
                            : OptionFeatures.Screen_Space_UV_Fragment);
                    ...
                    if (UvSource == UvSourceType.WorldPosition)
                    {
                        list.Add((program == ProgramType.Vertex)
                            ? OptionFeatures.World_Pos_UV_Vertex
                            : OptionFeatures.World_Pos_UV_Fragment);
                    }
                ...
                [Serialization.SerializeAs("triplanar_local")]
                public bool LocalSpaceTriplanar;

                [Serialization.SerializeAs("def")]
                public string DefaultValue = SGUILayout.Constants.DefaultTextureValues[0];

                [Serialization.SerializeAs("locked_uv"), ExcludeFromCopy]
                public bool IsUvLocked;
                ...
                [Serialization.SerializeAs("ssuv_vert")]
                public bool ScreenSpaceUVVertex;

                [Serialization.SerializeAs("ssuv_obj")]
                public bool ScreenSpaceUVObjectOffset;
                ...
                [Serialization.SerializeAs("uv_shaderproperty")]
                public string LinkedShaderPropertyName;
                ...
                public void TryToFindLinkedShaderProperty()
                {
                    ...
                    var match = Array.Find(ShaderGenerator2.CurrentConfig.VisibleShaderProperties,
                        sp => sp.Name == LinkedShaderPropertyName);
                    if (match != null)
                    {
                ...
                void SetLinkedShaderProperty(ShaderProperty shaderProperty)
                {
                    ...
                    if (shaderProperty == ParentShaderProperty)
                    {
                        Debug.LogError(ShaderGenerator2.ErrorMsg(
                            "Shader Property Referenced implementation tried to reference its parent: '" +
                            shaderProperty.Name + "'"));
                        return;
                    }
                    ...
                    if (Dependencies.Contains(shaderProperty))
                    {
                        ...
                        Debug.LogError(ShaderGenerator2.ErrorMsg("Cyclic reference between '" +
                                                                 this.ParentShaderProperty.Name + "' and '" +
                                                                 shaderProperty.Name + "'"));
                        return;
                    }
                    ...
                    bool sourceIsColor = shaderProperty.Type == VariableType.color ||
                                         shaderProperty.Type == VariableType.color_rgba;
                    ...
                    switch (shaderProperty.Type)
                    {
                        case VariableType.@float:
                            ...
                            break;
                        case VariableType.float2:
                            UvChannelsOptions = "XY";
                            break;
                        case VariableType.float3:
                            UvChannelsOptions = "XYZ";
                            break;
                        case VariableType.float4:
                            UvChannelsOptions = "XYZW";
                            break;
                        case VariableType.color:
                            UvChannelsOptions = "RGB";
                            break;
                        case VariableType.color_rgba:
                            UvChannelsOptions = "RGBA";
                            break;
                    }
                ...
                bool uvExpandedCache
                {
                    get
                    {
                        ...
                        {
                            _uvExpandedCache =
                                ParentShaderProperty.implementationsExpandedStates.Contains(this.guid.GetHashCode());
                        }
                ...
                public void SetScreenSpaceUV()
                {
                    ...
                    var uvLabelArray = program == ProgramType.Vertex
                        ? SGUILayout.Constants.UvChannelOptionsVertex
                        : SGUILayout.Constants.UvChannelOptions;
                ...
                string GetUV(string input, string output, ProgramType programType)
                {
                    ...
                    else if (UvSource == UvSourceType.WorldPosition)
                    {
                        if (program == ProgramType.Vertex)
                        {
                            return string.Format("{0}.{1}", ShaderGenerator2.IsURP ? "worldPosUv" : "worldPosUv",
                                UVChannels.ToLowerInvariant());
                        }
                        else
                        {
                            // assume Fragment
                            return string.Format("{0}.{1}", ShaderGenerator2.IsURP ? "positionWS" : input + ".worldPos",
                                UVChannels.ToLowerInvariant());
                        }
                    }
                    else if (UvSource == UvSourceType.OtherShaderProperty)
                    {
                        if (LinkedShaderProperty.IsUsedInLightingFunction &&
                            ShaderGenerator2.CurrentPassHasLightingFunction)
                            return string.Format("{0}.{1}.{2}", output, LinkedShaderProperty.GetVariableName(),
                                UVChannels.ToLowerInvariant());
                        else
                            return string.Format("{0}.{1}", LinkedShaderProperty.GetVariableName(),
                                UVChannels.ToLowerInvariant());
                    }
                    else
                    {
                        ...
                        if (string.IsNullOrEmpty(coord))
                        {
                            ...
                            {
                                Debug.LogError(ShaderGenerator2.ErrorMsg(
                                    "Can't find UV coordinates for shader property: " + ParentShaderProperty.Name));
                                return null;
                            }
                        }
                        else
                        {
                            return string.Format("{0}.{1}.xy", programType == ProgramType.Vertex ? output : input,
                                coord);
                        }
                    }
                }
                ...
                void VerifyReferencedValuesValidity()
                {
                    ...
                    if (UseTilingOffset && !string.IsNullOrEmpty(TilingOffsetVariable))
                    {
                        ...
                        if (!availableValues.Exists(av =>
                            av.value == TilingOffsetVariable && string.IsNullOrEmpty(av.disabled)))
                        {
                    ...
                    if (UseScrolling && !string.IsNullOrEmpty(ScrollingVariable))
                    {
                        ...
                        if (!availableValues.Exists(av =>
                            av.value == ScrollingVariable && string.IsNullOrEmpty(av.disabled)))
                        {
                ...
                struct AvailableValue
                {
                    ...
                    public override string ToString()
                    {
                        return string.Format("[AvailableValue value: {0}, label: {1}, valueLabel: {2}, disabled: {3}]",
                            value, label, valueLabel, disabled);
                    }
                }
                ...
                {
                    return FetchValidValuesGeneric(imp => imp.HasValidTilingOffsetVariable(),
                        imp => imp.GetDefaultTilingOffsetVariable(), imp => imp.GetTilingOffsetVariableName());
                }
                ...
                {
                    return FetchValidValuesGeneric(imp => imp.HasValidScrollingVariable(),
                        imp => imp.GetDefaultScrollingVariable(), imp => imp.GetScrollingVariableName());
                }

                // Generic function to return available tiling/offset or scrolling variables
                List<AvailableValue> FetchValidValuesGeneric(Func<Imp_MaterialProperty_Texture, bool> checkFunction,
                    Func<Imp_MaterialProperty_Texture, string> valueFunction,
                    Func<Imp_MaterialProperty_Texture, string> valueLabelFunction)
                {
                    var list = new List<AvailableValue>();

                    if (ShaderGenerator2.CurrentConfig == null ||
                        ShaderGenerator2.CurrentConfig.VisibleShaderProperties == null)
                    {
                        return list;
                    }
                        ...
                        if (imp_mp_ct != null)
                        {
                            if (checkFunction(imp_mp_ct))
                            {
                                list.Add(new AvailableValue()
                                {
                                    ...
                                    disabled = imp_mp_ct.IsCustomMaterialPropertyReferenced()
                                        ? null
                                        : "(unused Custom Material Property)"
                                });
                            }
                        }
                    }
                ...
                internal override string PrintProperty(string indent)
                {
                    var prop = base.PrintProperty(indent) + string.Format("{3}{0} (\"{1}\", 2D) = \"{2}\" {{}}",
                        PropertyName, Label, DefaultValue,
                        UseTilingOffset && !UseCustomTilingOffsetVariable() ? "" : "[NoScaleOffset] ");
                    if (UseScrolling && !UseCustomScrollingVariable())
                        prop += string.Format(
                            "\n{0}[TCP2UVScrolling] {1}_SC (\"{2} UV Scrolling\", Vector) = (1,1,0,0)", indent,
                            PropertyName, Label);
                    if (RandomOffset)
                        prop += string.Format("\n{0}{1} (\"{2} UV Offset Speed\", Float) = 120", indent,
                            GetDefaultOffsetSpeedVariable(), Label);
                    if (SineAnimation)
                        prop += string.Format(
                            "\n{0}[TCP2Vector4FloatsDrawer(Speed,Amplitude,Frequency,Offset)] {1} (\"{2} UV Sine Distortion Parameters\", Float) = (1, 0.05, 1, 0)",
                            indent, GetDefaultSineAnimVariable(), Label);
                    if (MipProperty)
                        prop += string.Format("\n{0}{1}_Mip (\"{2} Mip Level\", Range(0,10)) = 0", indent, PropertyName,
                            Label);
                    return prop;
                }
                ...
                internal override string PrintVariableFragment(string inputSource, string outputSource,
                    string arguments)
                {
                    var tilingOffsetVariable = UseCustomTilingOffsetVariable()
                        ? TilingOffsetVariable
                        : GetDefaultTilingOffsetVariable();
                    ...
                    tilingMod += (UseTilingOffset && (!GlobalTilingOffset || UvSource != UvSourceType.Texcoord))
                        ? string.Format(" * {0}.xy", tilingOffsetVariable)
                        : "";
                    var offsetMod = (UseTilingOffset && (!GlobalTilingOffset || UvSource != UvSourceType.Texcoord))
                        ? string.Format(" + {0}.zw", tilingOffsetVariable)
                        : "";
                    var scrollingVariable =
                        UseCustomScrollingVariable() ? ScrollingVariable : GetDefaultScrollingVariable();
                    var scrollingMod = (UseScrolling && !GlobalScrolling)
                        ? string.Format(" + {1}(_Time.yy * {0}.xy)", scrollingVariable, NoTile ? "" : "frac")
                        : "";
                    var randomOffsetMod = (RandomOffset && !GlobalRandomOffset)
                        ? string.Format(" + hash22(floor(_Time.xx * {0}.xx) / {0}.xx)", GetDefaultOffsetSpeedVariable())
                        : "";
                    ...
                    if (SineAnimation)
                    {
                        ...
                        string uvSinPos = UvSource == UvSourceType.WorldPosition
                            ? "sinUvAnimVertexWorldPos"
                            : "sinUvAnimVertexPos";
                        string uvSinInput = string.Format("{0}.{1}", inputSource,
                            ShaderGenerator2.IsURP ? "[[INPUT_VALUE:" + uvSinPos + "]]" : uvSinPos);
                        string uvSinCalculation = string.Format("float2 {0} = ({1} * {2}.z) + (_Time.yy * {2}.x);",
                            uvSinVariable, uvSinInput, GetDefaultSineAnimVariable());
                        ShaderGenerator2.AppendLineBefore(uvSinCalculation);
                        uvSineMod = string.Format(
                            " + (((sin(0.9 * {0} + {1}.w) + sin(1.33 * {0} + 3.14 * {1}.w) + sin(2.4 * {0} + 5.3 * {1}.w)) / 3) * {1}.y)",
                            uvSinVariable, GetDefaultSineAnimVariable());
                    }
                    else
                    {
                        uvSineMod = "";
                    ...
                    if (UvSource == UvSourceType.Triplanar)
                    {
                        ...
                        bool useTilingOffset =
                            ((UseTilingOffset && (!GlobalTilingOffset || UvSource != UvSourceType.Texcoord)));
                        string texelScaling =
                            ScaleByTexelSize ? string.Format(" * {0}_TexelSize.xy", PropertyName) : "";
                        ...
                        {
                            triplanarTilingOffset = string.Format("float4({0}{5}, {1}{2}{3}{4})", triplanarTiling,
                                triplanarOffset, scrollingMod, randomOffsetMod, uvSineMod, texelScaling);
                        }
                        else
                        {
                        ...
                        {
                            worldPositionInput = ShaderGenerator2.IsURP
                                ? "positionWS"
                                : inputSource + ".[[INPUT_VALUE:worldPos]]";
                            worldNormalInput = ShaderGenerator2.IsURP
                                ? "normalWS"
                                : inputSource + ".[[INPUT_VALUE:worldNormal]]";
                        }

                        return string.Format("{0}({1}, {2}, {3}, {4})", function, PropertyName, triplanarTilingOffset,
                            worldPositionInput, worldNormalInput);
                    }

                    return string.Format("{0}({1}, {2}{3}{4}{5}{6}{7}){8}", function, PropertyName, coords, tilingMod,
                        scrollingMod, offsetMod, randomOffsetMod, uvSineMod, channels);
                }
                ...
                internal override string PrintVariableVertex(string inputSource, string outputSource, string arguments)
                {
                    ...
                    {
                        string uvSinVariable = string.Format("uvSinAnim_{0}", PropertyName);
                        string uvSinInput = UvSource == UvSourceType.WorldPosition
                            ? "sinUvAnimVertexWorldPos"
                            : "sinUvAnimVertexPos";
                        string uvSinCalculation = string.Format("float2 {0} = ({1} * {2}.z) + (_Time.yy * {2}.x);",
                            uvSinVariable, uvSinInput, GetDefaultSineAnimVariable());
                    ...
                    if (UvSource == UvSourceType.Triplanar)
                    {
                        ...
                        {
                            triplanarTilingOffset = string.Format("float4({0}, {1}{2}{3}{4})", triplanarTiling,
                                triplanarOffset, scrollingMod, randomOffsetMod, uvSineMod);
                        }
                        else
                        {
                            triplanarTilingOffset = useTilingOffset ? tilingOffsetVariable : "float4(1,1,0,0)";
                        ...
                        return string.Format("{0}({1}, {2}, {3}, {4}, {5})", function, PropertyName,
                            triplanarTilingOffset, GetMipValue(), worldPositionInput, worldNormalInput);
                    }

                    return string.Format("tex2Dlod({0}, float4({1}{2}{3}{4}{5}{6}, 0, {7})){8}", PropertyName, coords,
                        tilingMod, scrollingMod, offsetMod, randomOffsetMod, uvSineMod, GetMipValue(), channels);
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        ...
                        bool highlighted = !IsDefaultImplementation
                            ? DefaultValue != SGUILayout.Constants.DefaultTextureValues[0]
                            : DefaultValue != GetDefaultImplementation<Imp_MaterialProperty_Texture>().DefaultValue;
                        SGUILayout.InlineLabel("Default Value", highlighted);
                    ...
                    if (!IsCustomMaterialProperty)
                    {
                        BeginHorizontal();
                        {
                            bool highlighted = !IsDefaultImplementation
                                ? Channels != DefaultChannels
                                : Channels != GetDefaultImplementation<Imp_MaterialProperty_Texture>().Channels;
                            SGUILayout.InlineLabel("Swizzle", highlighted);
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? UvChannel > 0
                            : UvChannel != GetDefaultImplementation<Imp_MaterialProperty_Texture>().UvChannel;
                        ...
                        else
                        {
                            ...
                            if (GUI.changed)
                            {
                                if (Array.IndexOf(uvLabelArray, SGUILayout.Constants.screenSpaceUVLabel) == UvChannel &&
                                    !IsUvLocked)
                                {
                                    UvSource = UvSourceType.ScreenSpace;
                                }
                                else if (Array.IndexOf(uvLabelArray, SGUILayout.Constants.worldPosUVLabel) ==
                                    UvChannel && !IsUvLocked)
                                {
                                    UvSource = UvSourceType.WorldPosition;
                                    UvChannelsOptions = "XYZ";
                                }
                                else if (Array.IndexOf(uvLabelArray, SGUILayout.Constants.shaderPropertyUVLabel) ==
                                    UvChannel && !IsUvLocked)
                                {
                                    UvSource = UvSourceType.OtherShaderProperty;
                                    UvChannelsOptions = "XXX";
                                }
                                else if (Array.IndexOf(uvLabelArray, SGUILayout.Constants.triplanarUVLabel) ==
                                    UvChannel && !IsUvLocked)
                                {
                                    UvSource = UvSourceType.Triplanar;
                                    UvChannelsOptions = "XXX";
                        ...
                        if (UvSource == UvSourceType.WorldPosition || UvSource == UvSourceType.OtherShaderProperty)
                        {
                            ...
                            rect.y -= 2;
                            GUI.Label(rect, gc);
                            UVChannels = SGUILayout.GenericSwizzle(UVChannels, 2, UvChannelsOptions, 30,
                                showAvailableChannels: false);
                        }
                    }
                    EndHorizontal();
                    ...
                    if (uvExpandedCache)
                    {
                            ...
                            using (new EditorGUI.DisabledGroupScope(!showScreenSpaceUVOptions))
                            {
                                BeginHorizontal();
                                {
                                    bool highlighted = !IsDefaultImplementation
                                        ? ScreenSpaceUVVertex
                                        : ScreenSpaceUVVertex !=
                                          GetDefaultImplementation<Imp_MaterialProperty_Texture>().ScreenSpaceUVVertex;
                                    SGUILayout.InlineLabel("└   Vertex SSUV",
                                        "Calculate the screen space UV in the vertex shader, faster but can appear distorted",
                                        highlighted);
                                ...
                                using (new EditorGUI.DisabledGroupScope(ScreenSpaceUVVertex))
                                {
                                    ...
                                    {
                                        bool highlighted = !IsDefaultImplementation
                                            ? ScreenSpaceUVObjectOffset
                                            : ScreenSpaceUVObjectOffset !=
                                              GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                                  .ScreenSpaceUVObjectOffset;
                                        SGUILayout.InlineLabel("└   Obj Offset SSUV",
                                            "Align the UV with the object's pivot, so that the texture doesn't appear fixed on the screen (remove the 'shower door' effect)",
                                            highlighted);
                            ...
                            using (new EditorGUI.DisabledGroupScope(!showTriplanarUvOptions))
                            {
                                BeginHorizontal();
                                {
                                    bool highlighted = !IsDefaultImplementation
                                        ? LocalSpaceTriplanar
                                        : LocalSpaceTriplanar !=
                                          GetDefaultImplementation<Imp_MaterialProperty_Texture>().LocalSpaceTriplanar;
                                    SGUILayout.InlineLabel("└   Object Space",
                                        "Calculate the Triplanar UV in object space instead of world space",
                                        highlighted);
                        ...
                        BeginHorizontal();
                        {
                            bool highlighted = !IsDefaultImplementation
                                ? UseTilingOffset
                                : UseTilingOffset != GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                    .UseTilingOffset;
                        ...
                        if ((GlobalOptions.data.ShowDisabledFeatures || showTilingOptions) && !IsUvLocked)
                        {
                            using (new EditorGUI.DisabledGroupScope(!showTilingOptions))
                            {
                                BeginHorizontal();
                                {
                                    bool highlighted = !IsDefaultImplementation
                                        ? GlobalTilingOffset
                                        : GlobalTilingOffset != GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                            .GlobalTilingOffset;
                                    SGUILayout.InlineLabel("└   Global",
                                        "Makes the tiling/offset values global to the selected UV coordinates: all textures using the same UV coordinates will inherit the tiling/offset values defined for this texture.\nIt also means that they will be calculated in the vertex shader (faster but uses one interpolator).\n\nDoes not apply to screen space UV coordinates.",
                                        highlighted);
                        ...
                        showTilingOptions =
                            UseTilingOffset && !(UvSource == UvSourceType.Texcoord && GlobalTilingOffset);
                        if ((GlobalOptions.data.ShowDisabledFeatures || showTilingOptions))
                        {
                            using (new EditorGUI.DisabledGroupScope(!showTilingOptions))
                            {
                                ...
                                {
                                    bool highlighted = !IsDefaultImplementation
                                        ? UseCustomTilingOffsetVariable()
                                        : TilingOffsetVariable !=
                                          GetDefaultImplementation<Imp_MaterialProperty_Texture>().TilingOffsetVariable;
                                    SGUILayout.InlineLabel("└   Variable",
                                        "Defines the tiling/offset uniform variable.\nBy default, a new property will be created for this texture, however you can use another texture's tiling/offset variable so that this texture will be linked with it. You would typically do that if you have a normal map coupled with an albedo map, for example.",
                                        highlighted);
                                    var tilingOffsetVar = UseCustomTilingOffsetVariable()
                                        ? TilingOffsetVariableLabel
                                        : GetTilingOffsetVariableName();
                                    if (SGUILayout.ButtonPopup(tilingOffsetVar))
                                    {
                                        var menu = new GenericMenu();
                                        string label = string.Format("{0}: {1}", ParentShaderProperty.Name,
                                            GetTilingOffsetVariableName()); // note: has non-breaking space character
                                        if (ParentShaderProperty.Name ==
                                            "_CustomMaterialPropertyDummy") // TODO get rid of the dummy shader property for custom material properties?
                                        {
                                        ...
                                        foreach (var availableValue in availableValues)
                                        {
                                            ...
                                            if (string.IsNullOrEmpty(availableValue.disabled))
                                            {
                                                ...
                                                {
                                                    guiContent = new GUIContent(string.Format("{0}: {1}",
                                                        availableValue.label,
                                                        availableValue
                                                            .valueLabel)), // note: has non-breaking space character
                                            ...
                                            else
                                            {
                                                itemList.Add(new MenuItem()
                                                {
                                                    guiContent = new GUIContent(string.Format("{0}: {1} {2}",
                                                        availableValue.label, availableValue.valueLabel,
                                                        availableValue
                                                            .disabled)), // note: has non-breaking space character
                                                    on = this.TilingOffsetVariable == availableValue.value,
                                                    disabled = true
                                                });
                                            }
                                ...
                                BeginHorizontal();
                                {
                                    bool highlighted = !IsDefaultImplementation
                                        ? ScaleByTexelSize
                                        : ScaleByTexelSize != GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                            .ScaleByTexelSize;
                                    SGUILayout.InlineLabel("└   Scale by Texel Size",
                                        "Will scale the UV by the texture's texel size. Usually useful to get pixel-perfect screen space UV mapping on the screen.",
                                        highlighted);
                        ...
                        {
                            bool highlighted = !IsDefaultImplementation
                                ? UseScrolling || RandomOffset || SineAnimation
                                : (UseScrolling != GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                       .UseScrolling ||
                                   RandomOffset != GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                       .RandomOffset ||
                                   SineAnimation != GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                       .SineAnimation);
                        ...
                        bool showUvAnimationOptions = (UseScrolling || RandomOffset || SineAnimation) &&
                                                      UvSource == UvSourceType.Texcoord;
                                ...
                                if (UseScrolling)
                                {
                                    BeginHorizontal();
                                    {
                                        bool highlighted = !IsDefaultImplementation
                                            ? GlobalScrolling
                                            : GlobalScrolling !=
                                              GetDefaultImplementation<Imp_MaterialProperty_Texture>().GlobalScrolling;
                                        SGUILayout.InlineLabel("└   Global",
                                            "Makes the scrolling global to the selected UV coordinates: all textures using the same UV coordinates will inherit the scrolling animation and values defined for this texture.\nIt also means that they will be calculated in the vertex shader (faster but uses one interpolator).",
                                            highlighted);
                                    ...
                                    bool showScrollingVariable = UseScrolling &&
                                                                 !(UvSource == UvSourceType.Texcoord &&
                                                                   GlobalScrolling);
                                    if ((GlobalOptions.data.ShowDisabledFeatures || showScrollingVariable))
                                    {
                                        using (new EditorGUI.DisabledGroupScope(!showScrollingVariable))
                                        {
                                            ...
                                            {
                                                bool highlighted = !IsDefaultImplementation
                                                    ? UseCustomScrollingVariable()
                                                    : ScrollingVariable !=
                                                      GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                                          .ScrollingVariable;
                                                SGUILayout.InlineLabel("└   Variable",
                                                    "Defines the scrolling uniform variable.\nBy default, a new property will be created for this texture, however you can use another texture's scrolling variable so that this texture will be linked with it.",
                                                    highlighted);
                                                var scrollingVar = UseCustomScrollingVariable()
                                                    ? ScrollingVariableLabel
                                                    : GetScrollingVariableName();
                                                if (SGUILayout.ButtonPopup(scrollingVar))
                                                {
                                                    ...
                                                    if (itemList.Count > 0)
                                                    {
                                                        ...
                                                        foreach (var item in itemList)
                                                        {
                                                            ...
                                                            {
                                                                menu.AddItem(item.guiContent, item.on,
                                                                    item.menuFunction);
                                                            }
                                                        }
                                                    }
                                        ...
                                        bool highlighted = !IsDefaultImplementation
                                            ...
                                            : GlobalRandomOffset !=
                                              GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                                  .GlobalRandomOffset;
                                        SGUILayout.InlineLabel("└   Global",
                                            "Makes the random offset global to the selected UV coordinates: all textures using the same UV coordinates will inherit the random offset animation and values defined for this texture.\nIt also means that they will be calculated in the vertex shader (faster but uses one interpolator).",
                                            highlighted);
                        ...
                        using (new EditorGUI.DisabledGroupScope(program != ProgramType.Fragment &&
                                                                !IsCustomMaterialProperty))
                        {
                            BeginHorizontal();
                            {
                                bool highlighted = !IsDefaultImplementation
                                    ? NoTile
                                    : NoTile != GetDefaultImplementation<Imp_MaterialProperty_Texture>().NoTile;
                                SGUILayout.InlineLabel("No Tile", "Use a special algorithm to prevent tile repetition",
                                    highlighted);
                        ...
                        {
                            TCP2_GUI.HelpBoxLayout(
                                "'Global Scrolling' and 'No Tile' don't work properly together: expect to see textures popping in their animation.",
                                MessageType.Warning);
                        }
                        ...
                        if (MipLevel >= 0 || IsCustomMaterialProperty)
                        {
                            BeginHorizontal();
                            {
                                bool highlighted = !IsDefaultImplementation
                                    ? MipLevel > 0
                                    : MipLevel != GetDefaultImplementation<Imp_MaterialProperty_Texture>().MipLevel;
                            ...
                            BeginHorizontal();
                            {
                                bool highlighted = !IsDefaultImplementation
                                    ? MipProperty
                                    : MipProperty != GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                        .MipProperty;
                                SGUILayout.InlineLabel("└   Material Property",
                                    "Create a material property to control the mip level for sampling this texture in the vertex shader",
                                    highlighted);
                    ...
                    if (UvSource == UvSourceType.OtherShaderProperty)
                    {
                        BeginHorizontal();
                        {
                            bool highlighted = !IsDefaultImplementation
                                ? false
                                : LinkedShaderPropertyName != GetDefaultImplementation<Imp_MaterialProperty_Texture>()
                                    .LinkedShaderPropertyName;
                            SGUILayout.InlineLabel("UV Shader Property", highlighted);

                            if (GUILayout.Button((LinkedShaderProperty != null) ? LinkedShaderProperty.Name : "None",
                                SGUILayout.Styles.ShurikenPopup))
                            {
                                var menu = ShaderProperty.Imp_ShaderPropertyReference.CreateShaderPropertiesMenu(
                                    this.ParentShaderProperty, this.LinkedShaderProperty, OnSelectShaderProperty);
                                if (menu != null)
                                {
                                    menu.ShowAsContext();
                                }
                    ...
                    if (UseTilingOffset && invalidTilingOffsetVariable)
                    {
                        ...
                        {
                            TCP2_GUI.HelpBoxLayout(
                                "The UV Tiling/Offset Variable is invalid.\nMaybe the original source has been removed or can't be used anymore?",
                                MessageType.Error);
                        }
                        EndHorizontal();
                    }
                    ...
                    if (UseScrolling && invalidScrollingVariable)
                    {
                        ...
                        {
                            TCP2_GUI.HelpBoxLayout(
                                "The UV Scrolling Variable is invalid.\nMaybe the original source has been removed or can't be used anymore?",
                                MessageType.Error);
                        }
                        EndHorizontal();
                    }
            ...
            public class Imp_ConstantValue : Implementation
            {
                ...
                [Serialization.SerializeAs("type"), ExcludeFromCopy]
                VariableType type;
                    ...
                    string arguments)
                {
                    switch (type)
                    {
                        ...
                        case VariableType.float2:
                            return string.Format(CultureInfo.InvariantCulture, "{0}2({1},{2})", floatPrec,
                                Float2Value.x, Float2Value.y);
                        case VariableType.float3:
                            return string.Format(CultureInfo.InvariantCulture, "{0}3({1},{2},{3})", floatPrec,
                                Float3Value.x, Float3Value.y, Float3Value.z);
                        case VariableType.float4:
                            return string.Format(CultureInfo.InvariantCulture, "{0}4({1},{2},{3},{4})", floatPrec,
                                Float4Value.x, Float4Value.y, Float4Value.z, Float4Value.w);
                        case VariableType.color:
                            return string.Format(CultureInfo.InvariantCulture, "{0}3({1},{2},{3})", floatPrec,
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        ...
                        switch (type)
                        {
                            ...
                            case VariableType.fixed_function_float:
                                highlighted = !IsDefaultImplementation
                                    ? FloatValue != 1.0f
                                    : FloatValue != GetDefaultImplementation<Imp_ConstantValue>().FloatValue;
                                break;
                            ...
                            case VariableType.float3:
                                highlighted = !IsDefaultImplementation
                                    ? Float2Value != Vector2.one
                                    : Float2Value != GetDefaultImplementation<Imp_ConstantValue>().Float2Value;
                                break;
                            case VariableType.float4:
                                highlighted = !IsDefaultImplementation
                                    ? Float3Value != Vector3.one
                                    : Float3Value != GetDefaultImplementation<Imp_ConstantValue>().Float3Value;
                                break;
                            case VariableType.color:
                            case VariableType.color_rgba:
                                highlighted = !IsDefaultImplementation
                                    ? ColorValue != Color.white
                                    : ColorValue != GetDefaultImplementation<Imp_ConstantValue>().ColorValue;
                                break;
                        }
                        ...
                        switch (type)
                        {
                            ...
                            case VariableType.float4:
                                ...
                                break;
                            case VariableType.color:
                                ColorValue = SGUILayout.ColorField(ColorValue, false,
                                    floatPrec != FloatPrecision.@fixed);
                                break;
                            case VariableType.color_rgba:
                                ColorValue = SGUILayout.ColorField(ColorValue, true,
                                    floatPrec != FloatPrecision.@fixed);
                                break;
                        }
                    }
                    ...
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? floatPrec != default(FloatPrecision)
                            : floatPrec != GetDefaultImplementation<Imp_ConstantValue>().floatPrec;
            ...
            public class Imp_ConstantFloat : Implementation
            {
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? FloatValue != 1.0f
                            : FloatValue != GetDefaultImplementation<Imp_ConstantFloat>().FloatValue;
                        SGUILayout.InlineLabel("Value", highlighted);
                        FloatValue = SGUILayout.FloatField(FloatValue);
                    }
                    EndHorizontal();
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? floatPrec != default(FloatPrecision)
                            : floatPrec != GetDefaultImplementation<Imp_ConstantFloat>().floatPrec;
                        SGUILayout.InlineLabel("Precision", highlighted);
                        floatPrec = (FloatPrecision) SGUILayout.EnumPopup(floatPrec);
                    }
                    EndHorizontal();
            ...
            public class Imp_VertexColor : Implementation
            {
                ...
                internal override OptionFeatures[] NeededFeatures()
                {
                    return new[] {OptionFeatures.VertexColors};
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Channels != DefaultChannels
                            : Channels != GetDefaultImplementation<Imp_VertexColor>().Channels;
                        SGUILayout.InlineLabel("Swizzle", highlighted);
            ...
            public class Imp_VertexTexcoord : Implementation
            {
                ...
                internal override string PrintVariableVertex(string inputSource, string outputSource, string arguments)
                {
                    ...
                    return string.Format("{0}.{1}.xy", inputSource,
                        string.IsNullOrEmpty(coord) ? "texcoord" + TexcoordChannel : coord);
                }
                    ...
                    string arguments)
                {
                    ...
                    if (string.IsNullOrEmpty(coord))
                    {
                        Debug.LogError(ShaderGenerator2.ErrorMsg("Can't find UV coordinates for Shader Property: " +
                                                                 ParentShaderProperty.Name));
                        return null;
                    }
                    else
                    {
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        ...
                        bool highlighted = !IsDefaultImplementation
                            ? TexcoordChannel > 0
                            : TexcoordChannel != GetDefaultImplementation<Imp_VertexTexcoord>().TexcoordChannel;
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Channels != DefaultChannels
                            : Channels != GetDefaultImplementation<Imp_VertexTexcoord>().Channels;
                        SGUILayout.InlineLabel("Swizzle", highlighted);
            ...
            public class Imp_LocalPosition : Implementation
            {
                ...
                public static string MenuLabel
                {
                    get { return "Vertex/Local Position"; }
                }
                ...
                internal override OptionFeatures[] NeededFeatures()
                {
                    return ParentShaderProperty.Program == ProgramType.Fragment
                        ? new[] {OptionFeatures.Local_Pos_Fragment}
                        : new OptionFeatures[0];
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Channels != DefaultChannels
                            : Channels != GetDefaultImplementation<Imp_LocalPosition>().Channels;
                        SGUILayout.InlineLabel("Swizzle", highlighted);
            ...
            public class Imp_WorldPosition : Implementation
            {
                ...
                public static string MenuLabel
                {
                    get { return "Vertex/World Position"; }
                }
                ...
                internal override OptionFeatures[] NeededFeatures()
                {
                    return new[]
                    {
                        ParentShaderProperty.Program == ProgramType.Vertex
                            ? OptionFeatures.World_Pos_UV_Vertex
                            : OptionFeatures.World_Pos_UV_Fragment
                    };
                }
                    ...
                    string arguments)
                {
                    var hideChannels = TryGetArgument("hide_channels", arguments);
                    var channels = string.IsNullOrEmpty(hideChannels) ? "." + Channels.ToLowerInvariant() : "";
                    return string.Format("{0}{1}", ShaderGenerator2.IsURP ? "positionWS" : inputSource + ".worldPos",
                        channels);
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Channels != DefaultChannels
                            : Channels != GetDefaultImplementation<Imp_WorldPosition>().Channels;
                        SGUILayout.InlineLabel("Swizzle", highlighted);
            ...
            public class Imp_LocalNormal : Implementation
            {
                ...
                public static string MenuLabel
                {
                    get { return "Vertex/Object Normal"; }
                }
                ...
                {
                    return ParentShaderProperty.Program == ProgramType.Fragment
                        ? new[] {OptionFeatures.Local_Normal_Fragment}
                        : new OptionFeatures[0];
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Channels != DefaultChannels
                            : Channels != GetDefaultImplementation<Imp_LocalNormal>().Channels;
                        SGUILayout.InlineLabel("Swizzle", highlighted);
            ...
            public class Imp_WorldNormal : Implementation
            {
                ...
                public static string MenuLabel
                {
                    get { return "Vertex/World Normal"; }
                }
                ...
                internal override OptionFeatures[] NeededFeatures()
                {
                    ...
                    {
                        ParentShaderProperty.Program == ProgramType.Vertex
                            ? OptionFeatures.World_Normal_Vertex
                            : OptionFeatures.World_Normal_Fragment
                    };
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Channels != DefaultChannels
                            : Channels != GetDefaultImplementation<Imp_WorldNormal>().Channels;
                        SGUILayout.InlineLabel("Swizzle", highlighted);
            ...
            public class Imp_GenericFromTemplate : Implementation
            {
                ...
                public static void EnableFromLine(string line, int pass, string program)
                {
                    ...
                    for (int i = 1; i < data.Length; i++)
                    {
                        ...
                        switch (subdata[0].Trim())
                        {
                            case "lbl":
                                ...
                                break;
                            case "compat":
                                compatibility = subdata1;
                                break;
                            case "help":
                                help = subdata1;
                                break;
                            case "toggles":
                                neededFeatures = subdata1;
                                break;
                            case "options":
                                options = subdata1;
                                break;
                            case "custom_code_compatible":
                                customCodeCompatible = bool.Parse(subdata1);
                                break;
                        }
                    }
                    ...
                    var imp = new GenericImplementation()
                    {
                        ...
                        Compatibility = (compatibility == "all")
                            ? VariableTypeAll
                            : (VariableType) Enum.Parse(typeof(VariableType), compatibility),
                        VariableName = name,
                ...
                public static void DisableFromLine(string line, int pass, string program)
                {
                    ...
                    {
                        Debug.LogWarning(
                            ShaderGenerator2.ErrorMsg(
                                "Can't disable Generic Implementation with this identifier: " + id));
                    }
                }
                ...
                public static void ListCompleted()
                {
                    ...
                    if (notDisabled.Length > 0)
                    {
                        ...
                        Debug.LogWarning(ShaderGenerator2.ErrorMsg(
                            "Some Generic Implementations were not properly disabled in the template: " + notDisabled));
                    }
                }
                ...
                public VariableType VariableCompatibility
                {
                ...
                [Serialization.SerializeAs("source_id")]
                public string sourceIdentifier;

                [Serialization.SerializeAs("needed_features")]
                public string NeededFeaturesStr = "";

                [Serialization.SerializeAs("custom_code_compatible")]
                public bool WorksWithCustomCode = false;

                public string OptionsString = "";

                [Serialization.SerializeAs("options_v")]
                public Dictionary<string, bool> OptionsEnabled = new Dictionary<string, bool>();
                ...
                public override bool HasErrors
                {
                    get { return base.HasErrors || !sourceIsAvailable || isNotTheLastImplementation; }
                }
                ...
                void OnDeserialized()
                {
                    ...
                    var match = Imp_GenericFromTemplate.AvailableGenericImplementations.Find(gi =>
                        gi.identifier == this.sourceIdentifier);
                    if (match.valid)
                    {
                ...
                void DeduceChannelsSettings(ShaderProperty shaderProperty)
                {
                    ...
                    {
                        if (prevChannels != null && i < prevChannels.Length &&
                            this.ChannelsOptions.Contains(prevChannels[i].ToString()))
                ...
                {
                    BeginHorizontal();
                    ShaderGenerator2.ContextualHelpBox("Special implementation defined in the template" +
                                                       (HelpMessage != null ? ":\n" + HelpMessage : "."));
                    EndHorizontal();
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Channels != DefaultChannels
                            : Channels != GetDefaultImplementation<Imp_GenericFromTemplate>().Channels;
                        SGUILayout.InlineLabel("Swizzle", highlighted);
                    ...
                    if (options != null)
                    {
                        for (int i = 0; i < options.Count; i++)
                        {
                            ...
                            BeginHorizontal();
                            {
                                EditorGUI.BeginChangeCheck();
                                bool highlighted = !IsDefaultImplementation
                                    ? OptionsEnabled[options[i].label]
                                    : OptionsEnabled[options[i].label] !=
                                      GetDefaultImplementation<Imp_GenericFromTemplate>()
                                          .OptionsEnabled[options[i].label];
                        ...
                        {
                            TCP2_GUI.HelpBoxLayout(
                                "The options for this Special Implementation are global across all the Properties.",
                                MessageType.Info);
                        }
                        EndHorizontal();
                    }
                    ...
                    if (!sourceIsAvailable)
                    {
                        ...
                        {
                            TCP2_GUI.HelpBoxLayout(
                                "This implementation is not available anymore, based on the selected features and options.",
                                MessageType.Error);
                        }
                        EndHorizontal();
                    }
                    ...
                    if (isNotTheLastImplementation)
                    {
                        ...
                        {
                            TCP2_GUI.HelpBoxLayout(
                                "This special implementation depends on the shader context and has to be the last implementation in the list.\nPlease drag its handle on the left and move it last.",
                                MessageType.Error);
                        }
                        EndHorizontal();
                    }
            ...
            public class Imp_Enum : Implementation
            {
                public static VariableType VariableCompatibility
                {
                    get { return VariableType.fixed_function_enum; }
                }

                public static string MenuLabel
                {
                    get { return "Enum (Fixed Function)"; }
                }
                ...
                [Serialization.SerializeAs("value_type")]
                public int ValueType;

                [Serialization.SerializeAs("value")] public int EnumValue;

                [Serialization.SerializeAs("enum_type")]
                ...
                public void Parse(string strValue)
                {
                    ...
                    {
                        Debug.LogError(ShaderGenerator2.ErrorMsg(
                            string.Format("Can't parse value '{0}' for type '{1}'.", strValue, EnumType)));
                        return;
                    }
                ...
                internal override string PrintProperty(string indent)
                {
                    if (!IsConstant())
                    {
                        return base.PrintProperty(indent) + string.Format("[Enum({0})] {1} (\"{2}\", Float) = {3}",
                            EnumType.Replace("+", "."), PropertyName(), Label,
                            Convert.ChangeType(enumValues[EnumValue].value, TypeCode.Int32));
                    }
                    else
                    {
                        return null;
                ...
                */
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? ValueType > 0
                            : ValueType != GetDefaultImplementation<Imp_Enum>().ValueType;
                    ...
                    else
                    {
                        BeginHorizontal();
                        {
                            bool highlighted = !IsDefaultImplementation
                                ? EnumValue > 0
                                : EnumValue != GetDefaultImplementation<Imp_Enum>().EnumValue;
                            SGUILayout.InlineLabel(TCP2_GUI.TempContent(IsConstant() ? "Value" : "Default Value"),
                                highlighted);
            ...
            public class Imp_CustomCode : Implementation
            {
                ...
                public static string MenuLabel
                {
                    get { return "Special/Custom Code"; }
                }
                ...
                internal override bool HasOperator()
                {
                    return false;
                }
                ...
                [Serialization.SerializeAs("prepend_type")]
                public PrependType prependType = PrependType.Disabled;

                [Serialization.SerializeAs("prepend_code")]
                public string prependCode = "";

                [Serialization.SerializeAs("prepend_file")]
                public string prependFileGuid = "";

                [Serialization.SerializeAs("prepend_file_block")]
                public string prependFileBlock = "";

                [Serialization.SerializeAs("preprend_params")]
                public Dictionary<string, string>
                    prependParametersValues =
                ...
                public override bool HasErrors
                {
                    get
                    {
                        return base.HasErrors | !string.IsNullOrEmpty(tagError) |
                               (prependType == PrependType.ExternalFile && prependFile != null &&
                                !prependFileBlockFound);
                    }
                }
                ...
                void TryFindPrependFileFromGuid()
                {
                    ...
                    {
                        var file = AssetDatabase.LoadAssetAtPath<TextAsset>(
                            AssetDatabase.GUIDToAssetPath(prependFileGuid));
                        if (file != null)
                        {
                            prependFile = file;
                            TryToFindPrependCodeBlock();
                ...
                Dictionary<string, string> PrintPrependCodeIfNeeded(Dictionary<Implementation, string> cachedVariables,
                    ...
                    else if (prependType == PrependType.ExternalFile && prependFile != null && prependFileBlockFound)
                    {
                        if (shaderUniqueVariableNamesMapping == null && prependReferences != null)
                        {
                            ...
                            foreach (var reference in prependReferences)
                            {
                                ...
                                shaderUniqueVariableNamesMapping.Add(reference.variableName,
                                    string.Format("{0}_{1}", reference.variableName, ShaderGenerator2.GlobalUniqueId));
                            }
                        }
                        ...
                        for (int i = 0; i < prependReferences.Count; i++)
                        {
                            ...
                            if (replacementParts.ContainsKey(reference.variableName))
                            {
                                ...
                                value = ParseReplacementParts(list, cachedVariables, inputSource, outputSource,
                                    arguments);
                            }
                        ...
                        foreach (var l in prependLines)
                        {
                            ...
                            {
                                if (reference.isComment) continue;
                                line = line.Replace(reference.variableName,
                                    shaderUniqueVariableNamesMapping[reference.variableName]);
                            }
                            ...
                            foreach (Match match in matches)
                            {
                                ...
                                {
                                    uniqueVariableReplacements.Add(toReplace,
                                        match.Groups[2].Value + "_" + ShaderGenerator2.GlobalUniqueId);
                                }
                ...
                public string PrintVariableReplacement(ref HashSet<Implementation> usedImplementations,
                    string inputSource, string outputSource, string arguments)
                {
                    ...
                    if (replacementParts.Count == 0)
                    {
                        // This shouldn't happen because this error is checked beforehand (disables 'Generate' button)
                        Debug.LogError(
                            ShaderGenerator2.ErrorMsg("Custom Code error: 'replacementParts' is null or empty"));
                        return null;
                    }
                        ...
                        foreach (var part in partsList)
                        {
                            if (part.StartsWith("tag:"))
                            {
                                ...
                                if (impIndex == customCodeIndex)
                                {
                                    // This shouldn't happen because this error is checked beforehand (disables 'Generate' button)
                                    Debug.LogError(ShaderGenerator2.ErrorMsg(
                                        "Custom Code error: the Custom Code implementation cannot reference itself!\nCustom Code index = " +
                                        customCodeIndex + ", Reference = {" + impIndex + "}"));
                                    return null;
                                }
                                ...
                                if (impIndex < customCodeIndex)
                                {
                                    // This shouldn't happen because this error is checked beforehand (disables 'Generate' button)
                                    Debug.LogError(ShaderGenerator2.ErrorMsg(
                                        "Custom Code error: the Custom Code implementation cannot reference previous implementations!\nCustom Code index = " +
                                        customCodeIndex + ", Reference = {" + impIndex + "}"));
                                    return null;
                                }
                    ...
                    if (usedImpsMultipleTimes.Count > 0)
                    {
                        ...
                        for (int i = 0; i < usedImpsMultipleTimes.Count; i++)
                        {
                            ...
                            var compatibility = (VariableType) imp.GetType().GetProperty("VariableCompatibility",
                            ...
                            {
                                ShaderGenerator2.AppendLineBefore(string.Format(format,
                                    (imp as Imp_GenericFromTemplate).PrintCustomCode()));
                            }
                            else if (ParentShaderProperty.Program == ProgramType.Vertex)
                            {
                                ShaderGenerator2.AppendLineBefore(string.Format(format,
                                    imp.PrintVariableVertex(inputSource, outputSource, argumentsHideChannels)));
                            }
                            else
                            {
                                ShaderGenerator2.AppendLineBefore(string.Format(format,
                                    imp.PrintVariableFragment(inputSource, outputSource, argumentsHideChannels)));
                            }
                        }
                    }
                    ...
                    // Prepend code if any
                    var replacementDict =
                        PrintPrependCodeIfNeeded(cachedVariables, inputSource, outputSource, arguments);
                ...
                string ParseReplacementParts(List<string> replacementPartsList,
                    Dictionary<Implementation, string> cachedVariables, string inputSource, string outputSource,
                    string arguments)
                {
                    string output = "";
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    else if (prependType == PrependType.ExternalFile)
                    {
                        BeginHorizontal();
                        {
                            ...
                            if (EditorGUI.EndChangeCheck())
                            {
                                prependFileGuid = prependFile != null
                                    ? AssetDatabase.AssetPathToGUID(AssetDatabase.GetAssetPath(prependFile))
                                    : "";
                                TryToFindPrependCodeBlock();
                            }
                        }
                                ...
                                for (int i = 0; i < prependReferences.Count; i++)
                                {
                                    ...
                                    else
                                    {
                                        BeginHorizontal(12);
                                        {
                                            ...
                                            EditorGUI.BeginChangeCheck();
                                            prependParametersValues[reference.variableName] =
                                                SGUILayout.TextField(prependParametersValues[reference.variableName],
                                                    false);
                                            if (EditorGUI.EndChangeCheck())
                                            {
                                                CheckReplacementTags();
                            ...
                            if (!prependFileBlockFound)
                            {
                                BeginHorizontal();
                                {
                                    EditorGUILayout.HelpBox(
                                        "Could not find the specified code block in the linked prepend file.",
                                        MessageType.Error);
                                }
                                EndHorizontal();
                            }
                    ...
                    else
                    {
                        BeginHorizontal();
                        {
                            GUILayout.Space(4);
                            TCP2_GUI.HelpBoxLayout(
                                "You can reference other implementations using <b>{n}</b> notation where <b>n</b> is the index of another implementation for this property, e.g.:\n<i>dot({1}, {2})</i>\n\nNote: the <b>operator</b> and <b>channels</b> for referenced implementations will be ignored!",
                                MessageType.Info);
                        }
                        EndHorizontal();
                    }
                ...
                public void TryToFindPrependCodeBlock()
                {
                    ...
                    string[] lines = System.IO.File.ReadAllLines(
                        ...
                        AssetDatabase.GetAssetPath(prependFile));
                ...
                void ParsePrependBlock(ref string[] lines, int startIndex)
                {
                    ...
                    for (int i = startIndex; i < lines.Length; i++)
                    {
                        ...
                        if (line.StartsWith("//#"))
                        {
                            ...
                            if (line.StartsWith("//# !"))
                            {
                                ...
                                prependReferences.Add(new PrependReference(VariableType.@float, "comment", comment,
                                    true));
                            }
                            ...
                            else
                            {
                                ...
                                string[] parts = prependRefStr.Split(new char[] {' '},
                                    System.StringSplitOptions.RemoveEmptyEntries);
                                if (parts.Length < 2)
                                {
                                    Debug.LogError(ShaderGenerator2.ErrorMsg(
                                        "Invalid prepend code reference, it should be in the following format:\n\"//# type name [defaultValue]\" (e.g. \"//# float4 myVariable (1.1, 2.0, 0.0, 4.0)\")\nParsed line:\n" +
                                        line));
                                }
                                else
                                {
                                    var vType = (ShaderProperty.VariableType) System.Enum.Parse(
                                        typeof(ShaderProperty.VariableType), parts[0]);
                                    if (!System.Enum.IsDefined(typeof(ShaderProperty.VariableType), vType))
                                    {
                                        Debug.LogError(ShaderGenerator2.ErrorMsg(
                                            "Invalid variable type defined for prepend code reference:\n" + line));
                                    }
                                    else
                                    {
                                        string name = parts[1];
                    ...
                    if (prependReferences.Count > 0)
                    {
                        ...
                        foreach (var reference in prependReferences)
                        {
                            ...
                            {
                                string defaultValue = string.IsNullOrEmpty(reference.defaultValueOrComment)
                                    ? getDefaultValueForType(reference.variableType)
                                    : reference.defaultValueOrComment;
                ...
                public void CheckReplacementTags()
                {
                    ...
                    else if (prependType == PrependType.ExternalFile && prependReferences != null &&
                             prependParametersValues != null)
                    {
                        for (int i = 0; i < prependReferences.Count; i++)
                        {
                            var reference = prependReferences[i];
                ...
                ReplacementTagsResult? ReplaceNNotationWithReplacementTags(string input, int customCodeIndex,
                    int maxIndex)
                {
                            ...
                            if (c == '}')
                            {
                                ...
                                if (int.TryParse(currentPart, out usedImpIndex))
                                {
                                    ...
                                    if (!usedImps.Contains(usedImpIndex))
                                    {
                                        ...
                                        {
                                            tagError =
                                                "Invalid code: the Custom Code implementation cannot reference itself";
                                            return null;
                                        }
                                        else if (usedImpIndex < customCodeIndex)
                                        {
                                            tagError =
                                                "Invalid code: the Custom Code implementation cannot reference previous implementations";
                                            return null;
                                        }
                                        else if (usedImpIndex > maxIndex)
                                        {
                                            tagError = "Invalid code: can't find implementation for index '" +
                                                       (usedImpIndex + 1) + "'";
                                            return null;
                                        }
                                        else
                                        {
                                            ...
                                            {
                                                tagError =
                                                    "Invalid code: the Custom Code implementation cannot reference certain Special implementations";
                                                return null;
                                            }
                                        }
                                    }
                                ...
                                {
                                    Debug.LogWarning(ShaderGenerator2.ErrorMsg(
                                        "Couldn't parse custom code tag content: \"" + currentPart + "\""));
                                }
            ...
            public class Imp_HSV : Implementation
            {
                public static VariableType VariableCompatibility
                {
                    get { return VariableType.color | VariableType.color_rgba; }
                }

                public static string MenuLabel
                {
                    get { return "Special/HSV"; }
                }
                ...
                internal override OptionFeatures[] NeededFeatures()
                {
                    return new[]
                    {
                        hsvType == HsvType.FullOffset
                            ? OptionFeatures.HSV_Full
                            : (hsvType == HsvType.Colorize ? OptionFeatures.HSV_Colorize : OptionFeatures.HSV_Grayscale)
                    };
                }

                internal override string[] NeededFeaturesExtra()
                {
                    return new[] {string.Format("HSV_COLORIZE_{0}", GetColorizeChannels())};
                }
                ...
                public override bool HasErrors
                {
                    get { return base.HasErrors | isFirstImplementation | noColorizeChannels; }
                }
                ...
                bool noColorizeChannels
                {
                    get { return (hsvType == HsvType.Colorize && !colorizeHue && !colorizeSat && !colorizeVal); }
                }
                ...
                void CheckValidity()
                {
                    if (ParentShaderProperty.implementations.Count < 2 ||
                        ParentShaderProperty.implementations[0] == this)
                    {
                ...
                internal override string PrintProperty(string indent)
                {
                    ...
                    if (group)
                    {
                        prop += string.Format("\n{0}[HideInInspector] __BeginGroup_HSV_{1} (\"{2} HSV\", Float) = 0",
                            indent, ToLowerCamelCase(ParentShaderProperty.Name), ParentShaderProperty.Name);
                        propName = "";
                    }
                    else
                    {
                    ...
                    if (hasHue)
                        prop += string.Format("\n{0}{1} (\"{2}Hue\", Range(-180,180)) = 0", indent, hueVariable,
                            propName);
                    if (hasSat)
                        prop += string.Format("\n{0}{1} (\"{2}Saturation\", Range(-2,2)) = {3}", indent,
                            saturationVariable, propName, hsvType == HsvType.SaturationOffset ? "1.0" : "0.0");
                    if (hasVal)
                        prop += string.Format("\n{0}{1} (\"{2}Value\", Range(-2,2)) = 0", indent, valueVariable,
                            propName);

                    if (group)
                        prop += string.Format("\n{0}[HideInInspector] __EndGroup (\"{1} HSV\", Float) = 0", indent,
                            ParentShaderProperty.Name);
                ...
                public string PrintVariableHSV(string currentReplacement)
                {
                    ...
                    {
                        return string.Format("ApplyHSV_{0}({1}, {2}, {3}, {4})",
                            VariableTypeToChannelsCount(variableType), currentReplacement, hueVariable,
                            saturationVariable, valueVariable);
                    }
                    else if (hsvType == HsvType.Colorize)
                    {
                        ...
                        return string.Format("Colorize{0}({1}, {2})", GetColorizeChannels(), currentReplacement,
                            colorizeArguments.TrimEnd(',').TrimStart());
                    }
                    else
                ...
                {
                    return string.Format("{0}{1}{2}", colorizeHue ? "H" : "", colorizeSat ? "S" : "",
                        colorizeVal ? "V" : "");
                }
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? hsvType != default(HsvType)
                            : hsvType != GetDefaultImplementation<Imp_HSV>().hsvType;
                    ...
                    if (hsvType == HsvType.Colorize)
                    {
                        BeginHorizontal();
                        {
                            bool highlighted = !IsDefaultImplementation
                                ? colorizeHue
                                : colorizeHue != GetDefaultImplementation<Imp_HSV>().colorizeHue;
                        ...
                        BeginHorizontal();
                        {
                            bool highlighted = !IsDefaultImplementation
                                ? colorizeSat
                                : colorizeSat != GetDefaultImplementation<Imp_HSV>().colorizeSat;
                        ...
                        BeginHorizontal();
                        {
                            bool highlighted = !IsDefaultImplementation
                                ? colorizeVal
                                : colorizeVal != GetDefaultImplementation<Imp_HSV>().colorizeVal;
                            SGUILayout.InlineLabel("Value", highlighted);
                    ...
                    if (HasErrors)
                    {
                        if (isFirstImplementation)
                        {
                            ...
                            {
                                TCP2_GUI.HelpBoxLayout(
                                    "HSV can't be the first implementation, because it applies to all the previous implementations before it.",
                                    MessageType.Error);
                            }
                            EndHorizontal();
                        }
                        ...
                        if (noColorizeChannels)
                        {
                            BeginHorizontal();
                            {
                                TCP2_GUI.HelpBoxLayout("You need to select the HSV channel(s) to colorize",
                                    MessageType.Error);
                            }
                            EndHorizontal();
                        }
            ...
            public class Imp_ShaderPropertyReference : Implementation
            {
                ...
                public static string MenuLabel
                {
                    get { return "Other Shader Property"; }
                }
                ...
                public override bool HasErrors
                {
                    get
                    {
                        return base.HasErrors | _linkedShaderProperty == null |
                    ...
                    string arguments)
                {
                    ...
                    if (LinkedShaderProperty.IsUsedInLightingFunction &&
                        ShaderGenerator2.CurrentPassHasLightingFunction)
                        return string.Format("{0}.{1}{2}", outputSource, LinkedShaderProperty.GetVariableName(),
                            channels);
                    else
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? false
                            : LinkedShaderPropertyName != GetDefaultImplementation<Imp_ShaderPropertyReference>()
                                .LinkedShaderPropertyName;
                        ...
                        if (GUILayout.Button((LinkedShaderProperty != null) ? LinkedShaderProperty.Name : "None",
                            SGUILayout.Styles.ShurikenPopup))
                        {
                            var menu = CreateShaderPropertiesMenu(this.ParentShaderProperty, this.LinkedShaderProperty,
                                OnSelectShaderProperty);
                            if (menu != null)
                            {
                                menu.ShowAsContext();
                            }
                    ...
                    if (LinkedShaderProperty != null)
                    {
                        ...
                        BeginHorizontal();
                        {
                            bool highlighted = !IsDefaultImplementation
                                ? Channels != DefaultChannels
                                : Channels != GetDefaultImplementation<Imp_ShaderPropertyReference>().Channels;
                            SGUILayout.InlineLabel("Swizzle", highlighted);
                ...
                public static GenericMenu CreateShaderPropertiesMenu(ShaderProperty parent, ShaderProperty selected,
                    GenericMenu.MenuFunction2 selectCallback)
                {
                    var menu = new GenericMenu();
                    var shaderProperties =
                        new List<ShaderProperty>(ShaderGenerator2.CurrentConfig.VisibleShaderProperties);
                ...
                static bool CheckCyclicReferences(ShaderProperty parent, ShaderProperty reference)
                {
                    ...
                    foreach (var imp in reference.implementations)
                    {
                        ...
                        if (impMpTex != null && impMpTex.UvSource ==
                            Imp_MaterialProperty_Texture.UvSourceType.OtherShaderProperty)
                        {
                ...
                void SetLinkedShaderProperty(ShaderProperty shaderProperty)
                {
                    ...
                    {
                        if (prevChannels != null && i < prevChannels.Length &&
                            options.Contains(prevChannels[i].ToString()))
                            Channels += prevChannels[i];
                        else
            ...
            public class Imp_CustomMaterialProperty : Implementation
            {
                ...
                public static string MenuLabel
                {
                    get { return "Custom Material Property"; }
                }
                ...
                public CustomMaterialProperty LinkedCustomMaterialProperty
                {
                    ...
                    set
                    {
                        ...
                        LinkedCustomMaterialPropertyName = _linkedCustomMaterialProperty == null
                            ? ""
                            : _linkedCustomMaterialProperty.PropertyName;
                    }
                }
                ...
                public override bool HasErrors
                {
                    get { return base.HasErrors | LinkedCustomMaterialProperty == null | errorMessage != null; }
                }
                ...
                public override void CheckErrors()
                {
                    ...
                    {
                        var imp_texture =
                            this.LinkedCustomMaterialProperty.implementation as Imp_MaterialProperty_Texture;
                ...
                {
                    Channels = LinkedCustomMaterialProperty != null
                        ? LinkedCustomMaterialProperty.GetChannelsForVariableType(ParentShaderProperty.Type)
                        : "-";
                    DefaultChannels = Channels;
                ...
                internal override void NewLineGUI(bool usedByCustomCode)
                {
                    BeginHorizontal();
                    ShaderGenerator2.ContextualHelpBox(
                        "Reference a Custom Material Property for this Shader Property. This is an easy way to define material properties that can be reused across the shader.\nFor example, you can embed 4 different masks into one texture, each mask being mapped to the R,G,B,A channels.");
                    EndHorizontal();
                    ...
                    BeginHorizontal();
                    {
                        ...
                        if (GUILayout.Button(
                            (LinkedCustomMaterialProperty != null) ? LinkedCustomMaterialProperty.Label : "None",
                            SGUILayout.Styles.ShurikenPopup))
                        {
                    ...
                    BeginHorizontal();
                    {
                        bool highlighted = !IsDefaultImplementation
                            ? Channels != DefaultChannels
                            : Channels != GetDefaultImplementation<Imp_CustomMaterialProperty>().Channels;
                        SGUILayout.InlineLabel("Swizzle", highlighted);
                ...
                GenericMenu CreateCustomMaterialPropertiesMenu()
                {
                    ...
                    if (customTextures != null && customTextures.Length > 0)
                    {
                        ...
                        {
                            menu.AddItem(new GUIContent(string.Format("{0} ({1})", ct.Label, ct.PropertyName)),
                                LinkedCustomMaterialProperty == ct, OnSelectCustomTexture, ct);
                        }
