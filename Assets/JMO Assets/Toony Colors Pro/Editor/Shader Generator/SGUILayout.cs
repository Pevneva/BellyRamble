...
namespace ToonyColorsPro
{
    namespace ShaderGenerator
    {
        static class SGUILayout
        {
            ...
            public static Rect GetControlRect(GUIStyle style, float height = Styles.shurikenLineHeight,
                float width = 0f)
            {
...
#if !UNITY_2019_3_OR_NEWER
					var rect =
 GUILayoutUtility.GetRect(GUIContent.none, TCP2_GUI.ShurikenMiniButton, GUILayout.Height(15), GUILayout.Width(w));
					rect.height = 12;
					...
					if(options.Length == 2)
						...
						style =
 (i == 0) ? TCP2_GUI.ShurikenMiniButtonLeft : (i == (options.Length-1) ? TCP2_GUI.ShurikenMiniButtonRight : TCP2_GUI.ShurikenMiniButtonMid);
#else
            ...
            public static bool Foldout(bool foldout, GUIContent label, bool highlighted = false, float width = 130)
            {
                ...
                var rect = GUILayoutUtility.GetRect(label,
                    highlighted ? Styles.GrayMiniLabelHighlighted : Styles.GrayMiniLabel,
                    GUILayout.Height(Styles.shurikenLineHeight), GUILayout.Width(width));
            ...
            public static Rect InlineLabel(GUIContent label, bool highlight = false, float width = 130)
            {
                GUILayout.Space(Indent);
                var rect = GUILayoutUtility.GetRect(label,
                    highlight ? Styles.GrayMiniLabelHighlighted : Styles.GrayMiniLabel,
                    GUILayout.Height(Styles.shurikenLineHeight), GUILayout.Width(width));
#if !UNITY_2019_3_OR_NEWER
				rect.y -= 2;
#endif
            ...
            public static T DrawProObjectField<T>(T obj, params GUILayoutOption[] options) where T : UnityEngine.Object
            {
                ...
                var rect = EditorGUILayout.GetControlRect(false, Styles.shurikenLineHeight, Styles.ShurikenValue,
                    options);
                var btnRect = rect;
                btnRect.width = 20;
                ...
                GUI.Label(rect, TCP2_GUI.TempContent(obj != null ? obj.name : "None (" + typeof(T).ToString() + ")"),
            ...
            {
                return GUILayout.Button(label, Styles.ShurikenPopup, GUILayout.MinWidth(248),
                    GUILayout.MinHeight(Styles.shurikenLineHeight));
            }
            ...
            public static Color ColorField(Color c, bool alpha, bool hdr = false)
            {
                ...
                {
                    color = rect.Contains(Event.current.mousePosition)
                        ? Styles.colorFieldBorderColorHoverPro
                        : Styles.colorFieldBorderColorPro;
                }
                else
                {
                    color = rect.Contains(Event.current.mousePosition)
                        ? Styles.colorFieldBorderColorHover
                        : Styles.colorFieldBorderColor;
                }
            ...
            {
                var rect = EditorGUILayout.GetControlRect(false, Styles.shurikenLineHeight, Styles.ShurikenToggle,
